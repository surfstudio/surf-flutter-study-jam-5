...
import 'package:meme_generator/features/{{feature_name.snakeCase()}}/di/{{feature_name.snakeCase()}}_scope.dart';
import 'package:meme_generator/features/{{feature_name.snakeCase()}}/presentation/screens/{{screen_name.snakeCase()}}/{{screen_name.snakeCase()}}_model.dart';
import 'package:meme_generator/features/{{feature_name.snakeCase()}}/presentation/screens/{{screen_name.snakeCase()}}/{{screen_name.snakeCase()}}_screen.dart';

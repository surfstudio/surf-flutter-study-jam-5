...
class _MemeGeneratorScreenState extends State<MemeGeneratorScreen> {
  final TextEditingController imageUrlCcontroller = TextEditingController();
  void _pastePhotoFromInternet() async {
    final value = await Clipboard.getData('text/plain');
    if (value != null) {
      setState(() {
        imageUrlCcontroller.text = value.text ??
            's2.best-wallpaper.net/wallpaper/2560x1600/2104/Rhino-head-horn-eye-black-background_2560x1600.jpg';
      });
    }
  }
...
void _showMemTextDialog(context) {
  showDialog(
      ...
      builder: (BuildContext context) {
        final TextEditingController memTextController = TextEditingController();
        return MemTextDialog(
          memTextController: memTextController,
        );
      });
}

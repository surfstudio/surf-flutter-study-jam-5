...
class _MemeGeneratorScreenState extends State<MemeGeneratorScreen> {
  ...
  Future<void> _pastePhotoFromInternet() async {
    final value = await Clipboard.getData('text/plain');
    if (value != null) {
      setState(() {
        imageUrlController.text =
            value.text ?? 'https://cdn2.iconfinder.com/data/icons/picol-vector/32/image_add-1024.png';
      });
    }
  }
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    ...
                    child: textEditingController.text == ''
                        ? const Text(' Здесь мог бы быть ваш мем',
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              color: Colors.white,
                              fontFamily: 'Impact',
